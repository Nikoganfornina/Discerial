...
public class PreguntasFilosofia {
    ...
    public static void crearPreguntasFilosofia() {
        ...
        Object[][] preguntas = {
                ...
                {103, "¿Cuál es la doctrina filosófica que afirma que todo conocimiento proviene de la experiencia?", "Idealismo", "Racionalismo", "Dogmatismo", "Empirismo", "multiple"},
                {104, "¿Qué filósofo dijo 'pienso, luego existo'?", "Hume", "Nietzsche", "Kant", "Descartes", "multiple"},
                {105, "¿Qué filósofo propuso el imperativo categórico como principio moral?", "Platón", "Epicuro", "Descartes", "Kant", "multiple"},
                ...
                {114, "¿Qué filósofo habló del 'eterno retorno'?", "Kant", "Spinoza", "Heidegger", "Nietzsche", "multiple"},
                ...
                {141, "¿Qué filósofo introdujo el concepto de 'voluntad de poder'?", "Kant", "Sartre", "Heidegger", "Nietzsche", "multiple"},
                ...
                {145, "¿Qué filósofo dijo 'pienso, luego existo'?", "Nietzsche", "Aristóteles", "Sartre", "Descartes", "multiple"},
                ...
                {152, "¿Qué pensador es conocido por su teoría del 'eterno retorno'?", "Sartre", "Heidegger", "Kant", "Nietzsche", "multiple"},
