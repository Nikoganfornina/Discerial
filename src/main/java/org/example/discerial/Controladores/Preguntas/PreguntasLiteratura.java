...
public class PreguntasLiteratura {
    ...
    public static void crearPreguntasLiteratura() {
        ...
        Object[][] preguntas = {
                ...
                {317, "¿Quién escribió 'El príncipe'?", "Antoine Sainy Exupery", "Sócrates", "Platón", "Nicolás Maquiavelo", "multiple"},
                ...
                {355, "¿Quién escribió 'Moby Dick'?", "Edgar Allan Poe", "Mark Twain", "Nathaniel Hawthorne", "Herman Melville", "multiple"},
                ...
                {359, "¿Quién es el autor de 'La metamorfosis'?", "Thomas Mann", "Friedrich Nietzsche", "Albert Camus", "Franz Kafka", "multiple"},
                ...
                {365, "¿Quién escribió 'El Principito'?", "Paul Verlaine", "Jules Verne", "Victor Hugo", "Antoine de Saint-Exupéry", "multiple"},
                ...
                {388, "¿Quién es el autor de 'Ulises'?", "William Faulkner", "T. S. Eliot", "Bernard Shaw", "James Joyce", "multiple"},
                ...
                {394, "¿Qué poeta italiano escribió 'La Divina Comedia'?", "Giovanni Boccaccio", "Petrarca", "Virgilio", "Dante Alighieri", "multiple"},
