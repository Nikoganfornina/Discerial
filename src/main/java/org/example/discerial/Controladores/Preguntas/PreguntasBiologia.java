...
public class PreguntasBiologia {
    ...
    public static void crearPreguntasBiologia() {
        ...
        Object[][] preguntas = {
                ...
                {13, "¿Cuál es el componente principal de la pared celular en las plantas?", "Quitina", "Lignina", "Colágeno", "Celulosa", "multiple"},
                {14, "¿Qué hormona regula los niveles de glucosa en sangre?", "Adrenalina", "Tiroxina", "Glucagón", "Insulina", "multiple"},
                {15, "¿Cuál es el nombre del proceso de división celular que produce gametos?", "Mitosis", "Fusión", "Citocinesis", "Meiosis", "multiple"},
                {16, "¿Qué parte del cerebro está involucrada en la memoria y el aprendizaje?", "Tálamo", "Cerebelo", "Amígdala", "Hipocampo", "multiple"},
                {17, "¿Qué elemento es esencial para la formación de hemoglobina?", "Calcio", "Potasio", "Cobre", "Hierro", "multiple"},
                {18, "¿Cuál es el tipo de ARN que lleva la información genética desde el ADN hasta el ribosoma?", "ARN de transferencia", "ARN ribosómico", "ARN pequeño nuclear", "ARN mensajero", "multiple"},
                {19, "¿Qué estructura celular contiene enzimas digestivas?", "Núcleo", "Mitocondria", "Peroxisoma", "Lisosoma", "multiple"},
                {20, "¿Cuál es la unidad básica de la vida?", "Molécula", "Átomo", "Orgánulo", "Célula", "multiple"},
                {21, "¿Qué tipo de macromolécula forman las enzimas?", "Carbohidratos", "Lípidos", "Ácidos nucleicos", "Proteínas", "multiple"},
                {22, "¿Qué tipo de tejido cubre la superficie del cuerpo y órganos?", "Conectivo", "Muscular", "Nervioso", "Epitelial", "multiple"},
                {23, "¿Cuál es la función principal de los glóbulos rojos?", "Defensa contra infecciones", "Coagulación sanguínea", "Producción de anticuerpos", "Transporte de oxígeno", "multiple"},
                {24, "¿Qué gas liberan las plantas durante la fotosíntesis?", "Dióxido de carbono", "Nitrógeno", "Agua", "Oxígeno", "multiple"},
                ...
                {29, "¿Qué es un ecosistema?", "Un conjunto de organismos de la misma especie", "Relación entre depredadores y presas", "Un tipo de célula", "Una comunidad de organismos y su ambiente", "multiple"},
                {30, "¿Cuál es el principal componente del plasma sanguíneo?", "Glóbulos rojos", "Glóbulos blancos", "Plaquetas", "Agua", "multiple"},
                {31, "¿Qué es la ósmosis?", "Difusión de solutos", "Movimiento activo de agua", "Transporte de gases a través de la membrana", "Movimiento pasivo de agua a través de una membrana semipermeable", "multiple"},
                {32, "¿Qué función tienen las mitocondrias?", "Almacenamiento de ADN", "Síntesis de proteínas", "Respiración celular", "Producción de energía", "multiple"},
                {33, "¿Qué tipo de reproducción realizan las bacterias?", "Sexuada", "Por esporas", "Gemación", "Asexual", "multiple"},
                {34, "¿Qué molécula es la fuente principal de energía para las células?", "ADN", "ARN", "Glucosa", "ATP", "multiple"},
                {35, "¿Qué es un gen?", "Un tipo de célula", "Una proteína", "Una secuencia de ADN con información hereditaria", "Una unidad de herencia", "multiple"},
                {36, "¿Qué es la fotosíntesis?", "Proceso de respiración celular", "Proceso para descomponer glucosa", "Producción de calor por las plantas", "Proceso para convertir luz en energía química", "multiple"},
                {37, "¿Qué estructura permite la comunicación entre neuronas?", "Axón", "Dendrita", "Cuerpo celular", "Sinapsis", "multiple"},
                {38, "¿Qué son los antibióticos?", "Virus", "Bacterias", "Vacunas", "Medicamentos que matan o inhiben bacterias", "multiple"},
                {39, "¿Qué es la evolución?", "Cambio de estación", "Cambio de comportamiento", "Adaptación individual", "Cambio genético en una población a través del tiempo", "multiple"},
                {40, "¿Qué es la homeostasis?", "Cambio climático", "Movimiento de sangre", "Producción de hormonas", "Mantenimiento del equilibrio interno del cuerpo", "multiple"},
                {41, "¿Cuál es el nombre del pigmento que da color rojo a la sangre?", "Clorofila", "Melanina", "Mioglobina", "Hemoglobina", "multiple"},
                {42, "¿Qué función tienen las enzimas?", "Almacenar energía", "Construir células", "Transportar nutrientes", "Acelerar reacciones químicas", "multiple"},
                {43, "¿Qué es el ADN?", "Ácido ribonucleico", "Proteína", "Molécula energética", "Ácido desoxirribonucleico", "multiple"},
                {44, "¿Qué tipo de tejido conecta huesos entre sí?", "Muscular", "Cartílago", "Tejido epitelial", "Ligamento", "multiple"},
                {45, "¿Cuál es la principal función del sistema respiratorio?", "Digestión", "Circulación", "Filtración de aire", "Intercambio de gases", "multiple"},
                ...
                {48, "¿Cuál es el proceso por el cual las plantas liberan vapor de agua?", "Fotosíntesis", "Respiración", "Condensación", "Transpiración", "multiple"},
                {49, "¿Qué es un virus?", "Un organismo vivo", "Una célula", "Un agente infeccioso celular", "Un agente infeccioso no celular", "multiple"},
                {50, "¿Qué órgano produce insulina?", "Hígado", "Riñón", "Estómago", "Páncreas", "multiple"},
                ...
                {76, "¿Qué tipo de respiración utilizan las células animales?", "Fotosíntesis", "Fermentación", "Respiración anaeróbica", "Respiración aeróbica", "multiple"},
                ...
                {83, "¿Qué nombre recibe el proceso de creación de nuevas proteínas?", "Transcripción", "Síntesis proteica", "Replicación", "Traducción", "multiple"},
                {84, "¿Cuál es el órgano principal de la digestión?", "Corazón", "Pulmón", "Esófago", "Estómago", "multiple"},
                {85, "¿Qué tipo de célula produce insulina?", "Células alfa", "Células delta", "Células gamma", "Células beta", "multiple"},
                {86, "¿Qué es una enzima?", "Un carbohidrato", "Un lípido", "Un ácido nucleico", "Una proteína que cataliza reacciones", "multiple"},
                ...
                {89, "¿Qué es la inmunidad?", "Proceso de digestión", "Producción de energía", "Transporte de oxígeno", "Respuesta del cuerpo a patógenos", "multiple"},
                {90, "¿Qué nombre recibe el proceso por el cual las células se especializan?", "Multiplicación", "Meiosis", "Regeneración", "Diferenciación celular", "multiple"},
                ...
                {92, "¿Qué estructura une músculos a huesos?", "Ligamento", "Cartílago", "Fascia", "Tendón", "multiple"},
                ...
                {97, "¿Qué nombre recibe la unión de un espermatozoide y un óvulo?", "Ovulación", "Menstruación", "Implantación", "Fertilización", "multiple"},
