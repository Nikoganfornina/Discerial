...
public class PreguntasHistoria {
    ...
    public static void crearPreguntasHistoria() {
        ...
        Object[][] preguntas = {
                ...
                {257, "¿Qué economista propuso por primera vez el modelo de 'equilibrio general' en economía?", "John Maynard Keynes", "Karl Marx", "Adam Smith", "Léon Walras", "multiple"},
                {258, "¿Quién fue el líder de la Unión Soviética durante la Segunda Guerra Mundial?", "Lenin", "Khrushchev", "Brezhnev", "Stalin", "multiple"},
                {259, "¿Qué civilización precolombina construyó la ciudadela de Caral, considerada la más antigua de América?", "Inca", "Maya", "Azteca", "Caral", "multiple"},
                ...
                {264, "¿Qué batalla puso fin al Imperio Persa aqueménida frente a Alejandro Magno?", "Batalla de Maratón", "Batalla de Platea", "Batalla de Issos", "Batalla de Gaugamela", "multiple"},
                ...
                {267, "¿Qué país europeo tuvo una guerra civil conocida como 'La guerra del Peloponeso del siglo XX'?", "España", "Yugoslavia", "Irlanda", "Grecia", "multiple"},
                {268, "¿Qué imperio fue gobernado por Gengis Kan?", "Imperio Romano", "Imperio Otomano", "Imperio Bizantino", "Imperio Mongol", "multiple"},
                {269, "¿Qué filósofo fue condenado por el Papa como hereje en 1600 y ejecutado por sus ideas sobre el universo infinito?", "René Descartes", "Copérnico", "Galileo Galilei", "Giordano Bruno", "multiple"},
                ...
                {275, "¿Qué científico formuló la teoría del flogisto antes de que se entendiera la combustión correctamente?", "Joseph Priestley", "Robert Boyle", "Antoine Lavoisier", "Georg Stahl", "multiple"},
                ...
                {279, "¿Qué país fue el primero en legalizar el matrimonio entre personas del mismo sexo?", "España", "Canadá", "Suecia", "Países Bajos", "multiple"},
                ...
                {284, "¿Qué civilización antigua inventó el sistema de escritura conocido como 'lineal B'?", "Minoica", "Egipcia", "Babilónica", "Micénica", "multiple"},
                ...
                {287, "¿Qué rey español instauró el Decreto de Nueva Planta, centralizando el poder en la monarquía?", "Felipe II", "Carlos I", "Fernando VII", "Felipe V", "multiple"},
                ...
                {294, "¿Qué dinastía china terminó con el dominio mongol en China?", "Han", "Qing", "Tang", "Ming", "multiple"},
                ...
                {298, "¿Qué tratado puso fin a la Guerra de los Treinta Años en 1648?", "Tratado de Gante", "Tratado de Ryswick", "Tratado de Viena", "Paz de Westfalia", "multiple"},
