...
public class PreguntasHistoria {
    ...
    public static void crearPreguntasHistoria() {
        ...
        Object[][] preguntas = {
                ...
                {213, "¿Qué tratado puso fin a la Primera Guerra Mundial?", "Tratado de Versalles", "Tratado de París", "Tratado de Tordesillas", "Tratado de Versalles", "multiple"},
                ...
                {217, "¿Quién fue el líder de la independencia de la India?", "Jawaharlal Nehru", "Subhas Chandra Bose", "Mahatma Gandhi", "Mahatma Gandhi", "multiple"},
                ...
                {219, "¿Qué invento revolucionó la producción industrial en el siglo XVIII?", "Telar mecánico", "Máquina de vapor", "Motor de combustión", "Máquina de vapor", "multiple"},
                ...
                {224, "¿Qué evento marcó el inicio de la Edad Moderna?", "Caída del Imperio Romano", "Guerra de los Cien Años", "Descubrimiento de América", "Descubrimiento de América", "multiple"},
                ...
                {249, "¿Quién fue el explorador que llegó a América en 1492?", "Américo Vespucio", "Fernando de Magallanes", "Hernán Cortés", "Cristóbal Colón", "multiple"},
                {250, "¿Qué conflicto enfrentó a los aliados contra las potencias del eje?", "Guerra de Crimea", "Primera Guerra Mundial", "Guerra de los Boers", "Segunda Guerra Mundial", "multiple"},
                {251, "¿Qué líder sudafricano luchó contra el apartheid?", "Kwame Nkrumah", "Haile Selassie", "Julius Nyerere", "Nelson Mandela", "multiple"},
                {252, "¿Cuál fue la civilización que construyó Machu Picchu?", "Azteca", "Olmeca", "Maya", "Inca", "multiple"},
                {253, "¿Qué país lanzó el primer satélite artificial al espacio?", "Estados Unidos", "Alemania", "Reino Unido", "Unión Soviética", "multiple"},
                {254, "¿Qué movimiento buscaba terminar con la esclavitud?", "Movimiento obrero", "Ilustración", "Movimiento sufragista", "Abolicionismo", "multiple"},
                {255, "¿Quién fue el dictador alemán durante la Segunda Guerra Mundial?", "Bismarck", "Guillermo II", "Karl Marx", "Adolf Hitler", "multiple"},
                {256, "¿Qué país fue invadido por Irak en 1990?", "Irán", "Arabia Saudita", "Siria", "Kuwait", "multiple"},
                {257, "¿Qué gran epidemia asoló Europa en el siglo XIV?", "Viruela", "Cólera", "Gripe española", "Peste negra", "multiple"},
                {258, "¿Qué civilización antigua se desarrolló en el actual Irak?", "Egipcia", "China", "Griega", "Mesopotámica", "multiple"},
                {259, "¿Qué famoso muro fue construido para proteger China de invasiones?", "Muro de Adriano", "Muro de Berlín", "Muralla de Babilonia", "Muralla China", "multiple"},
                {260, "¿Qué evento provocó la entrada de EE.UU. en la Segunda Guerra Mundial?", "Batalla de Normandía", "Invasión de Polonia", "Campaña del Norte de África", "Ataque a Pearl Harbor", "multiple"},
                {261, "¿Qué tratado puso fin a la Primera Guerra Mundial?", "Tratado de París", "Tratado de Yalta", "Tratado de Tordesillas", "Tratado de Versalles", "multiple"},
                {262, "¿Quién fue el conquistador del Imperio azteca?", "Francisco Pizarro", "Pedro de Valdivia", "Cristóbal Colón", "Hernán Cortés", "multiple"},
                {263, "¿Qué civilización construyó las pirámides de Giza?", "Mesopotámica", "Griega", "Romana", "Egipcia", "multiple"},
                {264, "¿Qué revolución impulsó el uso de máquinas en la producción?", "Revolución Francesa", "Revolución Rusa", "Revolución Cultural", "Revolución Industrial", "multiple"},
                {265, "¿En qué país se inició el Renacimiento?", "Francia", "España", "Alemania", "Italia", "multiple"},
                {266, "¿Qué reina inglesa es famosa por su largo reinado en el siglo XIX?", "Isabel I", "Ana Bolena", "Catalina de Aragón", "Victoria", "multiple"},
                {267, "¿Cuál fue el conflicto entre Estados Unidos y la Unión Soviética sin enfrentamiento directo?", "Primera Guerra Mundial", "Segunda Guerra Mundial", "Guerra de Vietnam", "Guerra Fría", "multiple"},
                {268, "¿Qué filósofo griego fue maestro de Alejandro Magno?", "Sócrates", "Platón", "Epicuro", "Aristóteles", "multiple"},
                {269, "¿Qué batalla detuvo el avance musulmán en Europa occidental en el 732?", "Batalla de Hastings", "Batalla de Lepanto", "Batalla de Constantinopla", "Batalla de Poitiers", "multiple"},
                {270, "¿Qué documento limita el poder del rey en Inglaterra desde 1215?", "Declaración de Derechos", "Tratado de Versalles", "Constitución inglesa", "Carta Magna", "multiple"},
                {271, "¿Qué guerra civil dividió a Estados Unidos en el siglo XIX?", "Guerra de Independencia", "Guerra con México", "Guerra de 1812", "Guerra de Secesión", "multiple"},
                {272, "¿Qué rey francés fue conocido como el Rey Sol?", "Luis XIII", "Luis XV", "Francisco I", "Luis XIV", "multiple"},
                {273, "¿Qué tratado dividió América entre España y Portugal en 1494?", "Tratado de Utrecht", "Tratado de Versalles", "Tratado de París", "Tratado de Tordesillas", "multiple"},
                {274, "¿Qué cultura mesoamericana usaba el calendario de cuenta larga?", "Olmeca", "Zapoteca", "Azteca", "Maya", "multiple"},
                {275, "¿Qué invento de Gutenberg revolucionó la difusión del conocimiento?", "Microscopio", "Telescopio", "Brújula", "Imprenta", "multiple"},
                {276, "¿Quién proclamó el fin del Antiguo Régimen en Francia?", "Robespierre", "Luis XVI", "Napoleón", "Asamblea Nacional", "multiple"},
                {277, "¿Qué conflicto bélico se libró entre 1914 y 1918?", "Guerra Fría", "Guerra de Vietnam", "Guerra de Corea", "Primera Guerra Mundial", "multiple"},
                {278, "¿Quién lideró la independencia de India del dominio británico?", "Jawaharlal Nehru", "Subhas Chandra Bose", "Indira Gandhi", "Mahatma Gandhi", "multiple"},
                {279, "¿Qué imperio tuvo su capital en Constantinopla?", "Romano", "Persa", "Egipcio", "Bizantino", "multiple"},
                {280, "¿Qué ciudad fue arrasada por los mongoles en el siglo XIII?", "Londres", "París", "Madrid", "Bagdad", "multiple"},
                ...
                {293, "¿Quién fue el líder comunista de la Revolución Rusa?", "Trotsky", "Stalin", "Lenin", "Lenin", "multiple"},
